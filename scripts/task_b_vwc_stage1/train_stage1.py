"""Train Task B Stage1 with RSL-RL."""
...
parser = argparse.ArgumentParser(description="Train Task B Stage1 with RSL-RL.")
...
parser.add_argument("--ray-proc-id", "-rid", type=int, default=None, help="Configured by Ray integration.")
